...
export function ProductGrid({ selectedIds, onToggle }: ProductGridProps) {
  ...
  return <section id="flavours" className="mm-flavours" aria-labelledby="flavours-title">
    <div className="mm-flavours-intro"><div className="mm-container"><p className="mm-eyebrow">A TASTE FOR EVERY MOOD</p><h1 id="flavours-title">اكتشف حشوتك <em>المفضلة.</em></h1><p>حشوات الشوكولاتة السويسرية من ميلت مور في الرياض.<br />اختر ما تحب، واجمع تشكيلتك، وأرسلها لنا عبر واتساب.</p><span className="mm-flavours-count">{products.length} حشوة… والكثير من الحلاوة</span></div><span className="mm-flavours-watermark" aria-hidden="true">Melt.</span></div>
