...
function Macaron({ className = "" }: { className?: string }) {
  return (
    <svg
      ...
      aria-hidden="true"
    >
      <ellipse cx="30" cy="22" rx="22" ry="10" fill="#F4E8D4" />
      <ellipse cx="30" cy="38" rx="22" ry="10" fill="#E6D5BB" />
      <rect x="8" y="26" width="44" height="9" fill="#B8892D" />
      <ellipse cx="30" cy="22" rx="22" ry="3" fill="#F8F1E7" opacity="0.4" />
    </svg>
  )
}
  ...
  return (
    ...
    >
      <rect
        ...
        strokeWidth="1"
      />
      <line x1="23" y1="14" x2="23" y2="46" stroke="#B8892D" strokeWidth="1" />
      <line x1="37" y1="14" x2="37" y2="46" stroke="#B8892D" strokeWidth="1" />
      <line x1="10" y1="30" x2="50" y2="30" stroke="#B8892D" strokeWidth="1" />
    </svg>
  )
}
  ...
  return (
    ...
    >
      <g transform="translate(30 30)">
        ...
        <circle r="5" fill="#4B2E24" opacity="0.4" />
      </g>
    </svg>
  )
}
