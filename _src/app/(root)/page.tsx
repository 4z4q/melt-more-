...
export const metadata: Metadata = {
  ...
  title: "Black Chocolate | صواني ضيافة وشوكولاتة بلجيكية فاخرة في الرياض",

  // ✅ description يحتوي كل الكلمات المفتاحية المهمة بشكل طبيعي
  description:
    "بلاك شوكلت — صواني ضيافة شوكولاتة بلجيكية فاخرة مصنوعة يدوياً في الرياض. بكجات أفراح وزواج ومناسبات، توت مغطى بالشوكولاتة، أكثر من 30 نكهة. توصيل داخل الرياض. اطلب عبر واتساب.",
  ...
  keywords: [
    ...
    "شوكولاتة بلجيكية طازجة السعودية",
  ],

  openGraph: {
    title: "Black Chocolate | صواني ضيافة وشوكولاتة بلجيكية في الرياض",
    description:
      "شوكولاتة بلجيكية فاخرة مصنوعة يدوياً في الرياض. صواني ضيافة، بكجات أفراح ومناسبات، وتوت بالشوكولاتة. اطلب الآن عبر واتساب.",
    url: "/",
